...
BLOG_FILTER_PILLS_HTML = """
                    <div class="blog-index-toolbar" role="group" aria-label="Filter articles">
                        ...
                        <button type="button" class="blog-pill" data-blog-filter="autoimmune">Autoimmune</button>
                        <button type="button" class="blog-pill" data-blog-filter="associations">Associations</button>
...
UPDATES_MONTHLY_SECTIONS_HTML = """
                    <section class="seo-landing__block updates-month">
                        ...
                        <ul class="seo-landing__list">
                            <li><strong>Eating With IBD Kindle promo:</strong> header banner and <a href="/eating-with-ibd">book landing</a> updated for a limited-time free Amazon Kindle download (ends by Sep 28)</li>
...
METRICS_SUBTAB_HTML = """
                <article class="support-section seo-landing tab-page-section tab-page-section--compact">
                    <header class="page-header-compact">
                        <h2 class="page-header-compact__title">Website &amp; App Analytics</h2>
