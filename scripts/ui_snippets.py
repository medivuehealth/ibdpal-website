...
UPDATES_MONTHLY_SECTIONS_HTML = """
                    <section class="seo-landing__block updates-month">
                        ...
                        <ul class="seo-landing__list">
                            ...
                            <li><strong>Library counts:</strong> <strong>117 articles</strong>, <strong>37 guides</strong>, <strong>210+</strong> resource entries, <strong>250+</strong> sitemap education pages</li>
                        </ul>
                    </section>
                    <section class="seo-landing__block updates-month">
                        <h2>June 2026</h2>
